    ...
    def draw(self, screen, ship_velocity):
        ...
        for star in self.stars:
            if self.explosion_mode:
                ...
                base_brightness = int(255 * star['brightness'] * 1.5)  # Same as explosion brightness
                ...
                if speed_factor > 0.1:  # Threshold to switch between stationary and moving
                    ...
                    brightness = int(255 * star['brightness'] * base_brightness * depth_brightness * 0.85)  # 15% dimmer
                else:
                    # When stationary or very slow: use individual star brightness with depth
                    brightness = int(255 * star['brightness'] * 0.3 * depth_brightness * 0.85)  # 15% dimmer
