...
class BossWeaponBullet(GameObject):
    ...
    def __init__(self, x, y, vx, vy, angle=None):
        ...
        # 3-second lifespan for boss bullets
        self.lifespan = 3.0  # 3 seconds
...
class Scoreboard:
    ...
    def submit_score(self, player_name, score, level=1):
        ...
        try:
            ...
            # print(f"[SCOREBOARD DEBUG] submit_score() called - Player: {player_name}, Score: {score}, Level: {level}")
    ...
    def submit_score_async(self, player_name, score, level=1, callback=None):
        ...
        try:
            # print(f"[SCOREBOARD DEBUG] submit_score_async() called - Player: {player_name}, Score: {score}, Level: {level}")
...
class Game:
    ...
    def advance_level(self):
        ...
        # Reset UFO message shown flags for new level
        self.ufo_10_shown = False
        self.ufo_20_shown = False
        self.ufo_30_shown = False
        self.ufo_60_shown = False
    ...
    def draw_scoreboard(self, surface):
        ...
        try:
            ...
            inst_text = font_small.render("", True, WHITE)
