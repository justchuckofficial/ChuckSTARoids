                ...
                if self.check_wrapped_collision(self.ship.position, ufo.get_hitbox_center(), self.ship.radius, ufo.radius):
                    ...
                    if ufo.spinout_active:
                        ...
                        if self.ship.shield_hits > 0:
                            ...
                            # Add electric blue explosion particles for UFO
                            for _ in range(45):
                                self.explosions.add_explosion(
                                    ufo.position.x,
                                    ufo.position.y,
    ...
    def draw(self, dt=0.016):
        ...
        if self.game_state == "playing":
            ...
            if self.show_250k_message:
                ...
                message_250k_text = message_250k_font.render("250k Extra Life + Full Recharge!", True, YELLOW)
                # Apply 15-degree skew effect
                ...
                message_100k_text = message_100k_font.render("100k Ability Double Charged!", True, YELLOW)
                # Apply 15-degree skew effect
            ...
            if self.show_nice_shot_message:
                ...
                nice_shot_text = nice_shot_font.render("Nice shot, kid!", True, (0, 255, 0))  # Green color
            ...
            # Lowest priority UI messages (UFO count and multiplier) - only show if no higher priority messages
                ...
                ufo_20_text = ufo_20_font.render("20+ Launch fighters!", True, YELLOW)
                ...
                ufo_10_text = ufo_10_font.render("10+ All ships, fire at will!", True, YELLOW)
        ...
        if self.game_state == "waiting":
            ...
            controls_text1 = controls_font.render("MOVE - w a s d + arrow keys  .  SHOOT - space  .  BLAST - q b shift  .  BRAKE - e ctrl", True, (200, 200, 200))
