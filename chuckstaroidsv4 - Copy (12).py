    ...
    def draw(self, dt=0.016):
        ...
        if self.game_state == "playing":
            ...
            # Lowest priority UI messages (UFO count and multiplier) - only show if no higher priority messages
                ...
                ufo_90_text = ufo_90_font.render("We've got incoming!", True, YELLOW)
                ...
                ufo_60_text = ufo_60_font.render("This is where the fun begins.", True, YELLOW)
                ...
                ufo_30_text = ufo_30_font.render("Stay on target… stay on target…", True, YELLOW)
                ...
                mult_5x_text = mult_5x_font.render("Great, kid, don't get cocky.", True, YELLOW)
                ...
                mult_4x_text = mult_4x_font.render("The Force will be with you, always.", True, YELLOW)
                ...
                mult_3x_text = mult_3x_font.render("We've got them on the run!", True, YELLOW)
