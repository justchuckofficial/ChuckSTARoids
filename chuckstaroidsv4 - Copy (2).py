...
MAX_PARTICLES = 1000  # Global particle limit for performance
PARTICLE_SOFT_LIMIT = 500  # Start reducing particle generation (50% of original)

# Asteroid system limits
MAX_ASTEROIDS = 256  # Global asteroid limit for performance
