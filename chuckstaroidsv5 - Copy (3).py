...
class Scoreboard:
    ...
    def submit_score(self, player_name, score, level=1):
    ...
    def submit_score_async(self, player_name, score, level=1, callback=None):
        """Submit score in background thread"""
        try:
            
            def _submit():
                try:
                    success, message = self.submit_score(player_name, score, level)
                    if callback:
