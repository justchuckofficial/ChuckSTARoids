...
MAX_PARTICLES = 1250  # Global particle limit for performance (50% of original)
PARTICLE_SOFT_LIMIT = 1000  # Start reducing particle generation (50% of original)

# Asteroid system limits
MAX_ASTEROIDS = 100  # Global asteroid limit for performance
...
class Ship(GameObject):
    ...
    def draw(self, screen):
        ...
        if self.image:
            # Use unified ship drawing function
            ...
            # Draw ship
            color = WHITE
            if self.invulnerable and is_invulnerability_flashing(self.invulnerable_time):
...
class Game:
    ...
    def spawn_asteroids(self, count=None):
        ...
        if self.level >= 2:
            # Calculate additional asteroids: max(0, (int(level - .5) - 1)
