    ...
    def submit_score(self, player_name, score):
        ...
        try:
            ...
            if not player_name or not isinstance(player_name, str):
                print(f"[SCOREBOARD DEBUG] Invalid player name: {player_name}")
...
class Game:
    ...
    def draw(self, dt=0.016):
        ...
        if self.game_state == "waiting":
            ...
            scoreboard_text = scoreboard_font.render("C - TAB", True, (150, 150, 150))
                    ...
                    for event in pygame.event.get():
                        if event.type == pygame.QUIT:
                            ...
                            if event.key not in excluded_keys:
                                ...
                                if self.name_input_active:
                                    # If in name input, just close the input dialog
                                    self.name_input_active = False
                                    self.player_name_input = ""
                                else:
